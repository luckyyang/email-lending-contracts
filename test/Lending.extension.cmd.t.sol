...
import "../src/DAI.sol";
import "../@email-wallet-local/test/helpers/EmailWalletCoreTestHelper.sol";
// import "../@email-wallet-local/src/verifier/AccountCreationVerifier.sol";
// import "../@email-wallet-local/src/verifier/AccountInitVerifier.sol";
// import "../@email-wallet-local/src/verifier/AccountTransportVerifier.sol";
// import "../@email-wallet-local/src/verifier/ClaimVerifier.sol";
// import "../@email-wallet-local/src/verifier/EmailSenderVerifier.sol";
// import "../@email-wallet-local/src/verifier/AnnouncementVerifier.sol";
// import "../@email-wallet-local/src/verifier/Verifier.sol";

// Testing extension functionality
contract LendingExtensionCommandTest is EmailWalletCoreTestHelper {
// contract LendingExtensionCommandTest is Test {
